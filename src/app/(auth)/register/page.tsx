...
export function metadata() {
  return {
    title: "Login System - Register Page",
    description: "This is the register page of the login system.",
  };
}
...
export default function RegisterPage() {
  return (
    <div className="w-full max-w-lg overflow-hidden rounded bg-white px-6 py-7 shadow">
      ...
      <p className="text-md mb-6 text-gray-600">Please register to continue</p>
      <RegisterForm />
